...
public:
	...
	~Onbon(void);
	BOOL InitOnbonSdk();
	BOOL PublishPrograms(CString strIP, CString strPort, CString strLedType, CString strDeviceModel, CString strPrgm, int nWidth, int nHieght, int nFontSize, int nEffect, int nPlaySpeed, int nStayTime);
	void OnbonReleaseSdk();
public:
	int ret;
	HINSTANCE hdll;
public:
...
#pragma endregion
	...
	******************************************************************/
	...
	typedef void(__stdcall *SetScreenParameter)(int nScreenNO, int nWidth, int nHeight, int  nScreenType, int nMkType, int  nDataDA, int  nDataOE, int nDataStyle, int nDataSort, int nFrequency, char* pFileName);
	typedef void(__stdcall *SetScreenState)(int nScreenNO, int bScreenState, char* pFileName);
	typedef void(__stdcall *SetScreenLight)(int nScreenNO, int nScreenLightValue, char* pFileName);
	typedef void(__stdcall *SetScreenDial)(int nX, int nY, int  nWidth, int  nHeight, int nAllDotRadius, int n369DotRadius, int nHourPointerWidth, int nMinutePointerWidth, int nAllDotColor, int n369DotColor, int nHourPointerColor, int nMinutePointerColor, int nSecondPointerColor, char* pFileName);
	typedef void(__stdcall *SetScreenTitle)(int nX, int nY, int nWidth, int nHeight, int nScreenType, int nMkType, char* pFontName, int nFontSize, int nFontColor, int bBold, int  bItalic, int  bUnderLine, char* pTitle, int nStunt, int nRunSpeed, int nShowTime, char* pFileName);
	typedef void(__stdcall *SetDynamicAttrib)(int nX, int  nY, int nWidth, int nHeight, int nScreenType, int  nMkType, int bShowExceptPic, int nExceptTime, char* pExceptPic, char* pFileName);
	typedef void(__stdcall *TranDynamicData)(int nScreenNO, int nOrdArea, int nX, int nY, int nWidth, int  nHeight, int nScreenType, int nMkType, int nPage, int nStunt, int  nRunSpeed, int  nShowTime, char* pSourceName, int  nSourceType, char* pDataFileName, int bDeleted);
	typedef void(__stdcall *TranDynamicString)(int nOrdArea, int nX, int nY, int nWidth, int nHeight, int nScreenType, int nMkType, int nStunt, int nRunSpeed, int  nShowTime, char*  DynamicString, char*  FontName, int FontSize, int  FontColor, int  FontBold, char* pDataFileName);
	typedef void(__stdcall *GetAllDataHead)(int nScreenNO, int  nProgramCount, char* pFileName);
	typedef void(__stdcall *GetProgramHead)(int nProgramOrd, int nAreaCount, int nProgPlayMode, int  nProgPlayLength, int  nProgWeekAttrib, int nPlayHour, int nPlayMinute, int nPlaySecond, int nStopHour, int nStopMintue, int nStopSecond, char*  pFileName);
	typedef void(__stdcall *GetCurDataTime)(char* pFileName);
	typedef void(__stdcall *SetScreenBmpText)(int nX, int  nY, int  nWidth, int  nHeight, int  nScreenType, int nMkType, char* pSourceFile, int nSourceType, int nStunt, int  nRunSpeed, int  nShowTime, char* pFileName, int bDeleted);
	typedef int(__stdcall *SendTCPIPData)(char* pTCPAddress, int  nPort, int nSendType, int  nWidth, int nHeight, int  nScreenTpe, char*  pSendBufFile);
	typedef void(__stdcall *ResiveCurTime)(int nScreenNO, int nYear, int nMonth, int nDay, int nHour, int nMinute, int nSecond, char* pFileName);
	typedef void(__stdcall *UnionAreaDataToFile)(char* pSourceFile, char* pUnionedFile, int bDeleted);
	typedef void(__stdcall *SetScreenDateTime)(int nX, int nY, int nWidth, int nHeight, char* pFontName, int nFontSize, int bBold, char* pStaticText, int nStaticColor, int bTimeDiff, int nHourDiff, int nMinuteDiff, int nDateStyle, int nDateColor, int nWeekStyle, int nWeekColor, int nTimeStyle, int nTimeColor, int bShowMuli, char* pFileName);
	typedef void(__stdcall *SetScreenTimer)(int nX, int nY, int nWidth, int nHeight, char* pFontName, int nFontSize, int bBold, char* pStaticText, int nStaticColor, int nTargYear, int nTargMonth, int nTargDay, int nTargHour, int nTargMinute, int nTargSecond, int nTimerColor, int bShowDay, int bShowHour, int bShowMinute, int bShowSecond, char* pFileName);
	typedef void(__stdcall *SetScreenTimerONOFF)(int nScreenNo, int nONHour1, int nONMinute1, int nOFFHour1, int nOFFMinute1, int nONHour2, int nONMinute2, int nOFFHour2, int nOFFMinute2, int nONHour3, int nONMinute3, int nOFFHour3, int nOFFMinute3, char* pFileName);
	typedef int(__stdcall *SendDataToComm)(int nScreenNO, char* pCom, int nBaud, int nSendType, int  nWidth, int  nHeight, int  nScreenType, char* pSendBufFile);

	SetScreenParameter api_SetScreenParameter;
	SetScreenState api_SetScreenState;
	SetScreenLight api_SetScreenLight;
	SetScreenDial api_SetScreenDial;
	SetScreenTitle api_SetScreenTitle;
	SetDynamicAttrib api_SetDynamicAttrib;
	TranDynamicData api_TranDynamicData;
	TranDynamicString api_TranDynamicString;
	GetAllDataHead api_GetAllDataHead;
	GetProgramHead api_GetProgramHead;
	GetCurDataTime api_GetCurDataTime;
	SetScreenBmpText api_SetScreenBmpText;
	SendTCPIPData api_SendTCPIPData;
	ResiveCurTime api_ResiveCurTime;
	UnionAreaDataToFile api_UnionAreaDataToFile;
	SetScreenDateTime api_SetScreenDateTime;
	SetScreenTimer api_SetScreenTimer;
